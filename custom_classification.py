...
# 训练模型
print("\n>>> 训练模板分类器 ...")
train_model(cls_model, train_loader_cls, dev_loader_cls, num_epochs=10, learning_rate=1e-4, is_token_classification=False)

print("\n>>> 训练槽位标注器 ...")
train_model(tok_model, train_loader_tok, dev_loader_tok, num_epochs=8, learning_rate=1e-4, is_token_classification=True)
