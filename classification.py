...
args_cls = TrainingArguments("cls_out", num_train_epochs=5, per_device_train_batch_size=16, learning_rate=5e-5, logging_steps=100, evaluation_strategy="epoch", save_strategy="epoch")
args_tok = TrainingArguments("tok_out", num_train_epochs=5, per_device_train_batch_size=16, learning_rate=3e-5, logging_steps=100, evaluation_strategy="epoch", save_strategy="epoch")
